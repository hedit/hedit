...
loadTranslation["english"] = function ( )
    ...
    -- /////////////////////////////////////////////////////////////////////////////////////////////////////////////////// --
    -------------------------------------------------------------------------------------------------------------------------
    uItemText["saveclient"]     = "Save"
    uItemText["loadclient"]     = "Load"
    uItemText["uploadshared"]   = "Upload"
    uItemText["downloadshared"] = "Download"
    uItemText["sharehandling"]  = "Share"
    uItemText["import"]         = "Import"
    uItemText["export"]         = "Export"
    -------------------------------------------------------------------------------------------------------------------------
    -- /////////////////////////////////////////////////////////////////////////////////////////////////////////////////// --
    -------------------------------------------------------------------------------------------------------------------------
